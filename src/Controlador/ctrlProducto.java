    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==vistaProducto.btnAgregar)
        {
            ...
            try {
                    ...
                    if (!texto2.matches("\\d+")) {
                        JOptionPane.showMessageDialog(null, "El precio solo puede tener numeros");                        
                    } else {
                        if (!texto3.matches("\\d+")) {
                        JOptionPane.showMessageDialog(null, "Las unidades solo puede tener numeros");                        
                        } else {
                ...
                System.out.println("erro en control producto" +epa.toString());
            }            
