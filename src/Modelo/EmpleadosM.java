...
//        }
    ...
    public boolean CAgregarEmpleado(EmpleadosM modeloEmpleados, JComboBox jcbGenero){        
        try {
    ...
    public boolean CMAgregarEmpleado(EmpleadosM modeloEmpleados, JComboBox jcbGenero, JComboBox jcbTipo ){
        try {
    ...
    public void CEliminar(CEmpleados vistaEmpleados){
    ...
    public void CActualizar(EmpleadosM modeloEmpleados, JComboBox jcbGenero, JComboBox jcbTipo, CEmpleados vistaEmpleados){  
    ...
    public void CMostrarEmpleados(CEmpleados vistaEmpleados){
        DefaultTableModel modelo = new DefaultTableModel();
        modelo.setColumnIdentifiers(new Object[]{"ID","Nombre", "Fecha Nacimiento", "Direccion", "Telefono","Correo", "Genero", "Tipo Empleado"});
        try {
            Statement st = CConexion.getConexion().createStatement();
