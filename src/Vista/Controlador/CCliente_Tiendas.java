...
public class CCliente_Tiendas extends javax.swing.JFrame {

    Desface desplace;

    public CCliente_Tiendas() {
        initComponents();
        ...
        rsscalelabel.RSScaleLabel.setScaleLabel(Casaicon4, "src/Vista/Iconos/hogar.png");
    ...
    private void initComponents() {
        ...
        MenuPlegable4 = new javax.swing.JPanel();
        btnCasa4 = new Vista.PanelCurvas();
        Casaicon4 = new javax.swing.JLabel();
        txtCasa4 = new javax.swing.JLabel();
        ...
        MenuPlegable4.setBackground(new java.awt.Color(64, 81, 115));
        MenuPlegable4.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        btnCasa4.setBackground(new java.awt.Color(64, 81, 115));
        btnCasa4.setRoundBottomLeft(25);
        btnCasa4.setRoundBottomRight(25);
        btnCasa4.setRoundTopLeft(25);
        btnCasa4.setRoundTopRight(25);
        btnCasa4.addMouseListener(new java.awt.event.MouseAdapter() {
        ...
        txtCasa4.setFont(new java.awt.Font("Leelawadee UI", 1, 18)); // NOI18N
        txtCasa4.setForeground(new java.awt.Color(255, 255, 255));
        txtCasa4.setText("Inicio");

        javax.swing.GroupLayout btnCasa4Layout = new javax.swing.GroupLayout(btnCasa4);
        btnCasa4.setLayout(btnCasa4Layout);
        btnCasa4Layout.setHorizontalGroup(
            btnCasa4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, btnCasa4Layout.createSequentialGroup()
                .addContainerGap(97, Short.MAX_VALUE)
                .addComponent(txtCasa4)
                .addGap(18, 18, 18)
                .addComponent(Casaicon4, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(14, 14, 14))
        );
        btnCasa4Layout.setVerticalGroup(
            btnCasa4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(btnCasa4Layout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addGroup(btnCasa4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Casaicon4, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtCasa4, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );

        MenuPlegable4.add(btnCasa4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 140, 230, -1));
        MenuPlegable4.add(txtLogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 90, 90));
        ...
        MenuPlegable4.add(txtBarras, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 10, 53, 53));
        ...
        MenuPlegable4.add(btnProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 350, -1, 50));
        ...
        MenuPlegable4.add(btnTrabajador, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 210, -1, 50));
        ...
        MenuPlegable4.add(btnBodega, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 280, -1, -1));
        ...
        MenuPlegable4.add(btnBitacora, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 630, -1, -1));
        ...
        MenuPlegable4.add(btnCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 420, 230, -1));
        ...
        MenuPlegable4.add(btnRuta, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 560, -1, -1));
        ...
        MenuPlegable4.add(btnVehiculos, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 490, 230, 53));

        jPanel1.add(MenuPlegable4, new org.netbeans.lib.awtextra.AbsoluteConstraints(-150, 0, 230, 760));
                ...
                if (resultado == 1) {
                    ...
                    try {
                        ...
                        if (rs2.next()) {
                            resultado2 = 1;
                            if (resultado == 1) {
                                CCliente_DatosTiendas vista = new CCliente_DatosTiendas();
                                vista.INIT();
                                this.dispose();
                            }
                        } else {
    ...
    private void txtBarrasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtBarrasMouseClicked
        if (MenuPlegable4.getX()==-150) {
            desplace.desplazarDerecha(MenuPlegable4, MenuPlegable4.getX(), 0, 15, 10);
        } else if(MenuPlegable4.getX() == 0) {
            desplace.desplazarIzquierda(MenuPlegable4, MenuPlegable4.getX(), -150, 15, 10);
        }
    ...
    private void btnCasaMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCasaMouseExited
        btnCasa4.setBackground(new Color(64,81,115));
    ...
    private void btnCasaMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCasaMouseEntered
        btnCasa4.setBackground(new Color(45,40,37));
    ...
    public void INIT(){
        ...
        modeloTiendas.CMostrarTabla(CvistaCliente);
        CvistaCliente.setVisible(true);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CCliente_Tiendas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//                new Cliente().setVisible(true);
    ...
    private javax.swing.JLabel Casaicon3;
    private javax.swing.JLabel Casaicon4;
    ...
    private javax.swing.JPanel MenuPlegable3;
    private javax.swing.JPanel MenuPlegable4;
    ...
    private Vista.PanelCurvas btnCasa3;
    private Vista.PanelCurvas btnCasa4;
    ...
    private javax.swing.JLabel txtCasa3;
    private javax.swing.JLabel txtCasa4;
