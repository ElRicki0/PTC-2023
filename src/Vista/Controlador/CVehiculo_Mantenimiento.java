...
public class CVehiculo_Mantenimiento extends javax.swing.JFrame {

    Desface desplace;
    Mantenimiento modelo = new Mantenimiento();
    
    public CVehiculo_Mantenimiento() {
    ...
    private void initComponents() {
        ...
        jPanel1.add(eliminar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 680, -1, -1));
    ...
    private void btnSubModeloMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSubModeloMouseClicked
        CVehiculo_Modelo vista = new CVehiculo_Modelo();
        vista.INIT();
        this.dispose();
    ...
    public void INIT(){
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CVehiculo_Mantenimiento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
